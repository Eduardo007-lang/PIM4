...
namespace PIM_4_PERIODO.View.__Tela_Principal__.Oficina
{
    public partial class Oficina : Form
    {
        ...
        private void Repoisicionamento_Label(Label Error_Label)
        {
            ...
            Error_Label.Location = new Point((this.Width / 2) - (Error_Label.Width / 2), CadastroOficina_Label.Location.Y + Error_Label.Height + CadastroOficina_Label.Height + 5);
        }
        ...
        {
            if (TxTBox_NomeOficina.Text != "" && TxTBox_RazaoSocial.Text != "" && TxTBox_CNPJ.Text != "" && TxTBox_SiteOficina.Text != "" &&
                TxTBox_Endereco.Text != "")
            {
